...
| 材料 | 文件 | 说明 |
|---|---|---|
| **① 作业报告** | [`yyy-作业报告.pdf`](yyy-作业报告.pdf) | 6 页 PDF · Markdown 源文件在 [`docs/实验报告.md`](docs/实验报告.md) |
| **② 源代码 URL** | [`yyy-源代码.txt`](yyy-源代码.txt) | 内容为本仓库的 GitHub 网址 |
| **③ 演示录屏** | [`yyy-演示.mp4`](yyy-演示.mp4) | 3 分 42 秒 MP4 · [4 分钟脚本见 `docs/录屏脚本.md`](docs/录屏脚本.md) |

> ⚠️ 提交前请把上述三个文件名中的 `yyy` 替换为实际**组号**（例如 `1-作业报告.pdf`）。
